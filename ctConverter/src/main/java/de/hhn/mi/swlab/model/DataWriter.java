...
public interface DataWriter {
   ...
   */
  void writeTxtFile(String filePath,String patientData) throws IOException;
   ...
   * @throws IOException exception
   */
  void writeBinFile(String filePath,ArrayList<Integer> imageData) throws IOException;
